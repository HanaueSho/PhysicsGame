...
void SphereObject::Init()
{
	...
	ID3D11ShaderResourceView* srv = Texture::Load("assets\\texture\\treeLeaf.png");
	...
	rigid->SetGravityScale(0.0f); // 落ちないように
	rigid->SetBodyType(Rigidbody::BodyType::Kinematic); // 基本的にキネマティック
}
