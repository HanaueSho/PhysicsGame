/*
	SpherePolygonReversee.cpp
	20241212 hanaue sho
*/
#include "SpherePolygonReverse.h"
#include "renderer.h"
#include "texture.h"
...
SpherePolygonReverse::SpherePolygonReverse(int division)
{
	// 頂点数の計算
...
SpherePolygonReverse::~SpherePolygonReverse()
{
	if (g_VertexBuffer)
	{
...
void SpherePolygonReverse::Draw() const
{
	// テクスチャの読み込み
