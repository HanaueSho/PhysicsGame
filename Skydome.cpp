...
void SkydomeObject::Init()
{
	...
	MeshFactory::CreateSphere(mf, { 500, 32, 32, true });
	...
	ID3D11ShaderResourceView* srv = Texture::Load("assets\\texture\\skydome.png");
...
void SkydomeObject::Update(float dt)
{
